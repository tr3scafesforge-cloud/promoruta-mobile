...
class GpsRepositoryImpl implements GpsRepository {
  ...
  Future<void> saveGpsPoint(GpsPoint point) async {
    await _localDataSource.saveGpsPoint(point);
  }
  ...
  @override
  Future<List<GpsPoint>> getGpsPoints(String routeId) async {
  ...
  Future<void> updateRoute(Route route) async {
    await _localDataSource.updateRoute(route);
  }

  @override
  Future<void> deleteRoute(String id) async {
    await _localDataSource.deleteRoute(id);
  }
