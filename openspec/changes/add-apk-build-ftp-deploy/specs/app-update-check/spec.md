# Capability: App Update Check

Enables the mobile application to detect when a new version is available and prompt users to download updates from an external distribution server.
